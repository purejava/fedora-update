...
export default class FedoraUpdatePreferences extends ExtensionPreferences {
	...
	fillPreferencesWindow(window) {
		...
		buildable.get_object('about_logo').set_from_file( this.dir.get_child('icons').get_path() + "/fedora-updates-logo.svg" );
